...
function personNode() {
  return {
    ...
    hasOccupation: {
      ...
      skills:
        "Node.js, Express.js, TypeScript, Python, Golang, REST API design, relational schema design, MySQL, PostgreSQL, pgvector, Redis, Docker, AWS, Nginx load balancing, PM2, CI/CD, zero-downtime deployments, observability, WebSockets, Redis Pub/Sub, Clean Architecture, caching strategies, distributed systems, horizontal scaling, idempotency and fault tolerance, payment integrations, RAG, LLM integration, React, Next.js, React Native, technical ownership, code review",
    },
    seeks: {
      "@type": "Demand",
