...
function personNode() {
  return {
    ...
    hasOccupation: {
      ...
      skills:
        "Node.js, Express.js, TypeScript, Python, Golang, REST API design, relational schema design, MySQL, PostgreSQL, pgvector, Redis, Docker, AWS, Nginx, PM2, CI/CD, WebSockets, Redis Pub/Sub, Clean Architecture, caching strategies, distributed systems, RAG, LLM integration, React, Next.js, React Native",
    },
    seeks: {
      "@type": "Demand",
